...
class ElizaTest(unittest.TestCase):
    ...
    def test_eliza_response():
        process = subprocess.Popen(['python', 'eliza.py', 'Hello'], stdout=subprocess.PIPE)
        stdout, _ = process.communicate()
        assert 'How do you do. Please tell me your problem.' in stdout.decode()
